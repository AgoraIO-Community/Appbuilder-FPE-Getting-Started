...
export const englishTranslationData: TextDataInterface = {
  ...
  shareRoomPSTNSubText: "Share this phone number and pin to dial from phone.1",
  ...
  permissionPopupSubHeading: "Select “Allow” for others to see and hear you1",
  //dismiss button text
  ...
  vbPanelImageUploadErrorToastSubHeading: "Selected image is already uploaded1",
  vbPanelImageTypeErrorToastHeading: "Upload Failed1",
  vbPanelImageTypeErrorToastSubHeading: "Please select a JPG or PNG file1",
  ...
  toolbarItemRecordingText: (active) => (active ? "Stop Rec1" : "Record1"),
  //leave button text
  ...
  nativeStopScreensharePopupPrimaryBtnText: "STOP SHARE & TURN CAMERA ON1",
  ...
  sttChangeSpokenLanguagePopupHeading: (isFirstTimeOpened) =>
    isFirstTimeOpened ? "Set Spoken Language1" : "Change Spoken Language1",
  ...
  privateChatInputPlaceHolderText: (name) => `Private Message to ${name}1`,
  ...
  livestreamingAttendeePresentYourScreenInfoHeading: "Present Your screen1",
  livestreamingAttendeePresentYourScreenInfoSubHeading:
    "Be a presenter post the host’s approval1",
  livestreamingAttendeeJoinWithActivitiesInfoHeading: "Join in activities1",
  ...
  livestreamRaiseHandRequestAcceptedToastSubHeading: "You are now a Presenter1",
  ...
  livestreamPromoteAsCoHostToastHeading: "Host promoted you as a Presenter1",
  ...
  videoRoomScreenShareErrorToastHeading: "Failed to initiate screen sharing1",
  ...
  authLogInRequiredPopupSubHeading: "Log-in to your organization to contiue1",
  authLogInRequiredPopupPrimaryBtnText: "LOGIN1",
  authLogInRequiredPopupSecondaryBtnText: "CLOSE APP1",

  //auth login error toast
  authSessionTimeoutToastHeading: "Your session has timed out, Retrying...1",
  authErrorOnLoginToastHeading: "Error occured on Login, Please login again.1",
